...
WHERE model_slug = 'claude-opus-4-7' AND status = 'active';
...
UPDATE provider_model_candidates SET cap_language_high=true, cap_build_high=true, cap_review=true, cap_tool_use=true, cap_build_med=true, cap_language_low=true, cap_build_low=true WHERE model_slug='claude-opus-4-7' AND status='active';
...
INSERT INTO task_type_routing (task_type, model_slug, provider_slug, permitted, rank, route_tier, route_tier_rank, latency_class, latency_rank, reasoning_control, route_health_score, observed_completed_count, observed_execution_failure_count, observed_external_failure_count, observed_config_failure_count, observed_downstream_failure_count, observed_downstream_bug_count, consecutive_internal_failures, last_failure_category, last_failure_zone, route_source, recent_successes, recent_failures) VALUES
    ('build', 'claude-opus-4-7',        'anthropic', true, 1, 'high',   1, 'reasoning', 1, '{"kind":"budgeted","parameter":"thinking.budget_tokens","adaptive_thinking":true,"extended_thinking":true}'::jsonb, 0.65, 0,0,0,0,0,0,0, '', '', 'explicit', 0,0),
...
INSERT INTO task_type_routing (task_type, model_slug, provider_slug, permitted, rank, route_tier, route_tier_rank, latency_class, latency_rank, reasoning_control, route_health_score, observed_completed_count, observed_execution_failure_count, observed_external_failure_count, observed_config_failure_count, observed_downstream_failure_count, observed_downstream_bug_count, consecutive_internal_failures, last_failure_category, last_failure_zone, route_source, recent_successes, recent_failures) VALUES
    ('architecture', 'claude-opus-4-7',        'anthropic', true, 1, 'high', 1, 'reasoning', 1, '{"kind":"budgeted","parameter":"thinking.budget_tokens","adaptive_thinking":true,"extended_thinking":true}'::jsonb, 0.65, 0,0,0,0,0,0,0, '', '', 'explicit', 0,0),
...
INSERT INTO task_type_routing (task_type, model_slug, provider_slug, permitted, rank, route_tier, route_tier_rank, latency_class, latency_rank, reasoning_control, route_health_score, observed_completed_count, observed_execution_failure_count, observed_external_failure_count, observed_config_failure_count, observed_downstream_failure_count, observed_downstream_bug_count, consecutive_internal_failures, last_failure_category, last_failure_zone, route_source, recent_successes, recent_failures) VALUES
    ...
    ('test', 'claude-opus-4-7',        'anthropic', true, 2, 'high',   2, 'reasoning', 2, '{"kind":"budgeted","parameter":"thinking.budget_tokens","adaptive_thinking":true,"extended_thinking":true}'::jsonb, 0.65, 0,0,0,0,0,0,0, '', '', 'explicit', 0,0),
...
INSERT INTO task_type_routing (task_type, model_slug, provider_slug, permitted, rank, route_tier, route_tier_rank, latency_class, latency_rank, reasoning_control, route_health_score, observed_completed_count, observed_execution_failure_count, observed_external_failure_count, observed_config_failure_count, observed_downstream_failure_count, observed_downstream_bug_count, consecutive_internal_failures, last_failure_category, last_failure_zone, route_source, recent_successes, recent_failures) VALUES
    ('review', 'claude-opus-4-7',              'anthropic', true, 1, 'high',   1, 'reasoning', 1, '{"kind":"budgeted","parameter":"thinking.budget_tokens","adaptive_thinking":true,"extended_thinking":true}'::jsonb, 0.65, 0,0,0,0,0,0,0, '', '', 'explicit', 0,0),
...
INSERT INTO task_type_routing (task_type, model_slug, provider_slug, permitted, rank, route_tier, route_tier_rank, latency_class, latency_rank, reasoning_control, route_health_score, observed_completed_count, observed_execution_failure_count, observed_external_failure_count, observed_config_failure_count, observed_downstream_failure_count, observed_downstream_bug_count, consecutive_internal_failures, last_failure_category, last_failure_zone, route_source, recent_successes, recent_failures) VALUES
    ('debate', 'claude-opus-4-7',        'anthropic', true, 1, 'high', 1, 'reasoning', 1, '{"kind":"budgeted","parameter":"thinking.budget_tokens","adaptive_thinking":true,"extended_thinking":true}'::jsonb, 0.65, 0,0,0,0,0,0,0, '', '', 'explicit', 0,0),
...
INSERT INTO task_type_routing (task_type, model_slug, provider_slug, permitted, rank, route_tier, route_tier_rank, latency_class, latency_rank, reasoning_control, route_health_score, observed_completed_count, observed_execution_failure_count, observed_external_failure_count, observed_config_failure_count, observed_downstream_failure_count, observed_downstream_bug_count, consecutive_internal_failures, last_failure_category, last_failure_zone, route_source, recent_successes, recent_failures) VALUES
    ('refactor', 'claude-opus-4-7',        'anthropic', true, 1, 'high',   1, 'reasoning', 1, '{"kind":"budgeted","parameter":"thinking.budget_tokens","adaptive_thinking":true,"extended_thinking":true}'::jsonb, 0.65, 0,0,0,0,0,0,0, '', '', 'explicit', 0,0),
