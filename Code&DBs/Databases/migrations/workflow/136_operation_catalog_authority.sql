...
CREATE TABLE IF NOT EXISTS operation_catalog_registry (
    ...
    source_kind TEXT NOT NULL CHECK (source_kind IN ('cqrs_command', 'cqrs_query')),
...
COMMENT ON TABLE operation_catalog_registry IS 'Canonical registry for CQRS operation definitions. This is the durable authority for operation identity, transport binding, and owning authority seams.';
...
CREATE TABLE IF NOT EXISTS operation_catalog_source_policy_registry (
    ...
    source_kind TEXT NOT NULL UNIQUE CHECK (source_kind IN ('cqrs_command', 'cqrs_query')),
...
COMMENT ON TABLE operation_catalog_source_policy_registry IS 'Canonical source-kind policy registry for operation definitions. CQRS command and query rows inherit posture and idempotency defaults from here instead of import-time heuristics.';
...
INSERT INTO operation_catalog_registry (
    ...
    (
        ...
        'runtime.cqrs.commands.workflow_build.MutateWorkflowBuildCommand',
        'runtime.cqrs.commands.workflow_build.handle_mutate_workflow_build',
    ...
    (
        ...
        'runtime.cqrs.commands.suggest_next.SuggestNextNodesCommand',
        'runtime.cqrs.commands.suggest_next.handle_suggest_next_nodes',
    ...
    (
        ...
        'runtime.cqrs.queries.roadmap_tree.QueryRoadmapTree',
        'runtime.cqrs.queries.roadmap_tree.handle_query_roadmap_tree',
    ...
    (
        ...
        'runtime.cqrs.queries.data_dictionary.QueryDataDictionary',
        'runtime.cqrs.queries.data_dictionary.handle_query_data_dictionary',
