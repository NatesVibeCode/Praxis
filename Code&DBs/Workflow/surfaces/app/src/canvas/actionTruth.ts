...
import { getCanvasPrimitive } from './canvasPrimitives';
...
export function getCatalogSurfacePolicy(item: CatalogItem): CatalogSurfacePolicy {
  ...
  const primitive = getCanvasPrimitive(item.actionValue);
...
export function isCanvasSurfaceAuthorityItem(item: CatalogItem): boolean {
