...
import type { OrbitNode, DockContent } from './canvasBuildPresenter';
...
export function CanvasPopout({
  ...
  const sections = useMemo<MenuSection[]>(() => {
    ...
    const toMenuAction = (
      ...
      meta,
      icon: <CanvasGlyph type={item.icon} size={14} color={node.route === item.actionValue ? 'currentColor' : 'var(--text)'} />,
      onSelect: () => {
