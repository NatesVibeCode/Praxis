        ...
        tool_praxis_bugs,
        {
            ...
            "inputSchema": {
                ...
                "properties": {
                    ...
                    "preview": {
                        "type": "boolean",
                        "description": "Alias for dry_run on action=file.",
                        "default": False,
                    },
                    ...
                    "preview": {
                        "type": "boolean",
                        "description": "When true, action='file' validates and returns the would-be record under 'would_file' without writing to the bug tracker.",
                        "default": False,
                    },
                },
                "required": ["action"],
