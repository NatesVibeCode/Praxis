...
CLI_TOOL_METADATA: dict[str, dict[str, Any]] = {
    ...
    "praxis_bugs": _tool(
        ...
        when_to_use="Inspect the bug tracker, file a new bug, or drive replay-ready bug workflows.",
    ...
    "praxis_discover": _tool(
        ...
        when_to_use="Search for functionally similar code before building something new.",
    ...
    "praxis_query": _tool(
        ...
        when_to_use="Route a natural-language question to the right platform subsystem from the terminal.",
    ...
    "praxis_recall": _tool(
        ...
        when_to_use="Search the knowledge graph for decisions, patterns, entities, and prior analysis.",
