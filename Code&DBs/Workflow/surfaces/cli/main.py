...
def _help_text() -> str:
    return "\n".join(
        [
            ...
            "  workflow setup|health|health-map|metrics|events|cache|circuits|slots|params|config|notifications|dashboard|api [routes|integrations|data-dictionary|--host|--port]|routes|supervisor|capabilities|work",
