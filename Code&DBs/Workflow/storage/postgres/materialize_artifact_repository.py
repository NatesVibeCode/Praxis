...
class PostgresCompileArtifactRepository:
    ...
    def upsert_compile_artifact(
        ...
        *,
        ...
        self._conn.execute(
            """
            INSERT INTO materialize_artifacts (
                materialize_artifact_id,
                artifact_kind,
                artifact_ref,
                revision_ref,
        ...
        *,
        ...
        rows = self._conn.execute(
            ...
            SELECT
                ...
                payload,
                decision_ref
            FROM materialize_artifacts
            WHERE artifact_kind = $1
              AND input_fingerprint = $2
            ORDER BY created_at ASC, materialize_artifact_id ASC
            """,
            _require_text(artifact_kind, field_name="artifact_kind"),
            _require_text(input_fingerprint, field_name="input_fingerprint"),
        )
    ...
    def load_compile_artifact_by_revision(
        ...
        *,
        ...
        rows = self._conn.execute(
            ...
            WHERE artifact_kind = $1
              AND revision_ref = $2
            ORDER BY created_at DESC, materialize_artifact_id DESC
            LIMIT 1
            """,
            _require_text(artifact_kind, field_name="artifact_kind"),
            _require_text(revision_ref, field_name="revision_ref"),
    ...
    def load_compile_artifact_lineage(
        ...
        *,
        ...
        rows = self._conn.execute(
            ...
            UNION ALL
            SELECT
                parent.materialize_artifact_id,
                ...
                parent.decision_ref,
                parent.created_at
            FROM materialize_artifacts parent
            JOIN lineage child
