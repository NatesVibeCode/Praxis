...
class MaterializeArtifactStore:
    ...
    def _upsert(
        ...
        *,
        ...
        materialize_artifact_id = f"materialize_artifact.{artifact_kind}.{content_hash[:16]}"
        self._repository().upsert_compile_artifact(
            materialize_artifact_id=materialize_artifact_id,
            artifact_kind=artifact_kind,
...
def _compile_artifact_record_from_row(
    ...
    *,
    ...
    return MaterializeArtifactRecord(
        materialize_artifact_id=_require_text(row.get("materialize_artifact_id"), field_name="materialize_artifact_id"),
        artifact_kind=artifact_kind,
