"""Loop / map primitive for dynamic parallel dispatch.
...
The loop is dispatch-level: it creates multiple independent
...
def loop_dispatch(
    ...
    **spec_kwargs: Any,
    ...
    ----------
    items:
        The list to loop over.  Each element is serialised and
...
def aggregate_loop_results(
    ...
    """Combine loop results into a summary dict.
