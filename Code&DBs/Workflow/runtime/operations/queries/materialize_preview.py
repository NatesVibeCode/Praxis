...
class MaterializePreviewQuery(BaseModel):
...
def handle_materialize_preview(query: MaterializePreviewQuery, subsystems: Any) -> dict[str, Any]:
...
__all__ = ["MaterializePreviewQuery", "handle_materialize_preview"]
