...
def test_source_refs_bug_prefix_routes_through_bugs_resolver(monkeypatch):
    ...
    monkeypatch.setattr(spec_compiler, "_plan_packets_from_bugs", fake_bugs)
...
def test_source_refs_mixed_kinds_dispatch_per_kind(monkeypatch):
    ...
    monkeypatch.setattr(spec_compiler, "_plan_packets_from_bugs", fake_bugs)
    monkeypatch.setattr(spec_compiler, "_plan_packets_from_roadmap_items", fake_roadmap)
...
def test_source_refs_empty_materialization_raises_specific_error(monkeypatch):
    ...
    monkeypatch.setattr(
        spec_compiler, "_plan_packets_from_bugs", lambda refs, *, conn, program_id: []
    )
