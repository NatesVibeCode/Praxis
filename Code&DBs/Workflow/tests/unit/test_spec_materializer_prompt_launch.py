...
def test_compile_prompt_launch_spec_uses_provider_default_model_when_model_missing(monkeypatch) -> None:
    ...
    spec = spec_materializer.materialize_prompt_launch_spec(
...
def test_compile_prompt_launch_spec_rejects_unadmitted_prompt_provider(monkeypatch) -> None:
    ...
    try:
        spec_materializer.materialize_prompt_launch_spec(
        ...
        raise AssertionError("materialize_prompt_launch_spec should reject unadmitted providers")
