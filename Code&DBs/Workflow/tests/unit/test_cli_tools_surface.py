    ...
    assert payload == [
        {
            ...
            "when_not_to_use": "Do not use it for direct tool execution or HTTP route browsing.",
            "authority": {
                "tool_name": "praxis_query_test",
                "selector_field": None,
                "selector_value": "query_test",
                "risk": "read",
                "surface": "query",
                "tier": "stable",
                ...
                "operation_name": "mcp.praxis_query_test.query_test",
                "legacy_status": "active",
                "migration_target": None,
                "decision_ref": "decision.cqrs_authority_unification.20260422",
            },
