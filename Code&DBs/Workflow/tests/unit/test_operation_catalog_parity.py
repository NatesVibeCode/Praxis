...
_SEEDED_OPERATION_ROWS = [
    ...
    {
        "operation_ref": "experiment-promote-winner",
        "operation_name": "experiment_promote_winner",
        "source_kind": "operation_command",
        "operation_kind": "command",
        "http_method": "POST",
        "http_path": "/api/experiment_promote_winner",
        "input_model_ref": "runtime.operations.commands.promote_experiment_winner_command.PromoteExperimentWinnerCommand",
        ...
        "enabled": True,
        "binding_revision": "binding.operation_catalog_registry.experiment_promote_winner.20260426",
        "decision_ref": "decision.operation_catalog_registry.experiment_promote_winner.20260426",
    ...
    },
    {
        ...
        "decision_ref": "decision.2026-04-28.compile-materialize-cqrs-registration",
    ...
    },
    {
        ...
        "enabled": True,
        "binding_revision": "binding.operation_catalog_registry.compile_preview.20260429",
        "decision_ref": "architecture-policy::compile-authority::compile-cqrs-shared-frontdoor",
        "event_required": False,
        "event_type": "compile_preview",
    },
    {
    ...
    {
        "operation_ref": "operator-provider-control-plane",
        "operation_name": "operator.provider_control_plane",
        "source_kind": "operation_query",
        "operation_kind": "query",
        "http_method": "GET",
        "http_path": "/api/operator/provider-control-plane",
        "input_model_ref": "runtime.operations.queries.circuits.QueryProviderControlPlane",
        ...
        "idempotency_policy": "read_only",
        "enabled": True,
        "binding_revision": "binding.operation_catalog_registry.provider_control_plane.20260426",
        "decision_ref": "decision.provider_control_plane.20260426",
    },
    {
    ...
    {
        "operation_ref": "operator-bug-triage-packet",
        "operation_name": "operator.bug_triage_packet",
        "source_kind": "operation_query",
        "operation_kind": "query",
        "http_method": "GET",
        "http_path": "/api/operator/bug-triage-packet",
        "input_model_ref": "runtime.operations.queries.operator_observability.QueryBugTriagePacket",
        ...
        "idempotency_policy": "read_only",
        "enabled": True,
        "binding_revision": "binding.operation_catalog_registry.bug_triage_packet.20260426",
        "decision_ref": "decision.operation_catalog_registry.bug_triage_packet.20260426",
    },
    {
        "operation_ref": "operator-execution-truth",
        "operation_name": "operator.execution_truth",
        "source_kind": "operation_query",
        "operation_kind": "query",
        "http_method": "GET",
        "http_path": "/api/operator/execution-truth",
        "input_model_ref": "runtime.operations.queries.operator_composed.QueryExecutionTruth",
        "handler_ref": "runtime.operations.queries.operator_composed.handle_query_execution_truth",
        "authority_ref": "authority.workflow_runs",
        "projection_ref": None,
        "posture": "observe",
        "idempotency_policy": "read_only",
        "enabled": True,
        "binding_revision": "binding.operation_catalog_registry.operator_composed.20260428",
        "decision_ref": "decision.operation_catalog_registry.operator_composed.20260428",
    },
    {
        "operation_ref": "operator-next-work",
        "operation_name": "operator.next_work",
        "source_kind": "operation_query",
        "operation_kind": "query",
        "http_method": "GET",
        "http_path": "/api/operator/next-work",
        "input_model_ref": "runtime.operations.queries.operator_composed.QueryNextWork",
        "handler_ref": "runtime.operations.queries.operator_composed.handle_query_next_work",
        "authority_ref": "authority.bugs",
        "projection_ref": None,
        "posture": "observe",
        "idempotency_policy": "read_only",
    ...
    {
        "operation_ref": "operator-provider-route-truth",
        "operation_name": "operator.provider_route_truth",
        "source_kind": "operation_query",
        "operation_kind": "query",
        "http_method": "GET",
        "http_path": "/api/operator/provider-route-truth",
        "input_model_ref": "runtime.operations.queries.operator_composed.QueryProviderRouteTruth",
        "handler_ref": "runtime.operations.queries.operator_composed.handle_query_provider_route_truth",
        "authority_ref": "authority.provider_onboarding",
        "projection_ref": None,
        "posture": "observe",
        "idempotency_policy": "read_only",
    ...
    {
        "operation_ref": "operator-runtime-truth-snapshot",
        "operation_name": "operator.runtime_truth_snapshot",
        "source_kind": "operation_query",
        "operation_kind": "query",
        "http_method": "GET",
        "http_path": "/api/operator/runtime-truth",
        "input_model_ref": "runtime.operations.queries.runtime_truth.QueryRuntimeTruthSnapshot",
        "handler_ref": "runtime.operations.queries.runtime_truth.handle_query_runtime_truth_snapshot",
        "authority_ref": "authority.workflow_runs",
        "projection_ref": None,
        "posture": "observe",
        "idempotency_policy": "read_only",
        "enabled": True,
        "binding_revision": "binding.operation_catalog_registry.runtime_truth.20260428",
        "decision_ref": "decision.operation_catalog_registry.runtime_truth.20260428",
    },
    {
        "operation_ref": "operator-firecheck",
        "operation_name": "operator.firecheck",
        "source_kind": "operation_query",
        "operation_kind": "query",
        "http_method": "GET",
        "http_path": "/api/operator/firecheck",
        "input_model_ref": "runtime.operations.queries.runtime_truth.QueryFirecheck",
        "handler_ref": "runtime.operations.queries.runtime_truth.handle_query_firecheck",
        "authority_ref": "authority.workflow_runs",
        "projection_ref": None,
        "posture": "observe",
        "idempotency_policy": "read_only",
    ...
    {
        "operation_ref": "operator-remediation-plan",
        "operation_name": "operator.remediation_plan",
        "source_kind": "operation_query",
        "operation_kind": "query",
        "http_method": "GET",
        "http_path": "/api/operator/remediation-plan",
        "input_model_ref": "runtime.operations.queries.runtime_truth.QueryRemediationPlan",
        "handler_ref": "runtime.operations.queries.runtime_truth.handle_query_remediation_plan",
        "authority_ref": "authority.receipts",
        "projection_ref": None,
        "posture": "observe",
        "idempotency_policy": "read_only",
    ...
    {
        "operation_ref": "operator-remediation-apply",
        "operation_name": "operator.remediation_apply",
        "source_kind": "operation_command",
        "operation_kind": "command",
        "http_method": "POST",
        "http_path": "/api/operator/remediation-apply",
        "input_model_ref": "runtime.operations.commands.runtime_remediation.RuntimeRemediationApplyCommand",
        "handler_ref": "runtime.operations.commands.runtime_remediation.handle_runtime_remediation_apply",
        "authority_ref": "authority.workflow_runs",
        "projection_ref": None,
        "posture": "operate",
        "idempotency_policy": "non_idempotent",
        ...
        "enabled": True,
        "binding_revision": "binding.operation_catalog_registry.runtime_remediation.20260428",
        "decision_ref": "decision.operation_catalog_registry.runtime_remediation.20260428",
    },
    {
        "operation_ref": "operator-operation-forge",
        "operation_name": "operator.operation_forge",
        "source_kind": "operation_query",
        "operation_kind": "query",
        "http_method": "GET",
        "http_path": "/api/operator/operation-forge",
        "input_model_ref": "runtime.operations.queries.operator_composed.QueryOperationForge",
        "handler_ref": "runtime.operations.queries.operator_composed.handle_query_operation_forge",
        "authority_ref": "authority.cqrs",
        "projection_ref": None,
        "posture": "observe",
        "idempotency_policy": "read_only",
        "enabled": True,
...
def test_seeded_operation_catalog_rows_resolve_to_live_bindings(monkeypatch) -> None:
    ...
    assert set(seeded) == {
        ...
        "operator.execution_truth",
        "operator.next_work",
        "operator.provider_route_truth",
        "operator.runtime_truth_snapshot",
        "operator.firecheck",
        "operator.remediation_plan",
        "operator.remediation_apply",
        "operator.operation_forge",
