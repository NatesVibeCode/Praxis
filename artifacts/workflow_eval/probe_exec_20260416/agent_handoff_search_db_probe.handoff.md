# Search Proof
- Workflow validate passed for `/Users/nate/Praxis/artifacts/workflow_eval/probe_exec_20260416/agent_handoff_search_db_probe.queue.json`.
- Workflow preview passed.
- `praxis workflow discover "workflow spec with agents handoff deterministic tooling search db action" --json` returned these top module/class paths: `runtime/workflow/decision_context.py`, `adapters/deterministic.py`, `surfaces/workflow_bridge.py`, `runtime/workflow_spec.py`, `runtime/observability.py`, `adapters/deterministic.py::DeterministicTaskAdapter`, `runtime/build_review_decisions.py`, `surfaces/api/handlers/_query_bugs.py`, `runtime/_workflow_database.py`, `runtime/workflow_worker.py`.
